(function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	let t1;
    	let span;
    	let t2_value = new Date(/*item*/ ctx[3].isoDate.replace(/ /g, "T")).toLocaleString("en-US", /*localeStringOptions*/ ctx[2]) + "";
    	let t2;
    	let t3;
    	let p;
    	let html_tag;
    	let raw_value = /*item*/ ctx[3].content + "";
    	let t4;
    	...
    	return {
    		...
    		h() {
    			attr(a, "href", a_href_value = /*item*/ ctx[3].link);
    			attr(div, "class", "newsTitle");
    			html_tag = new HtmlTag(raw_value, t4);
    			attr(p, "class", "newsContent");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*newsFeed*/ 2 && t0_value !== (t0_value = /*item*/ ctx[3].title + "")) set_data(t0, t0_value);

    			if (dirty & /*newsFeed*/ 2 && a_href_value !== (a_href_value = /*item*/ ctx[3].link)) {
    				attr(a, "href", a_href_value);
    			}

    			if (dirty & /*newsFeed*/ 2 && t2_value !== (t2_value = new Date(/*item*/ ctx[3].isoDate.replace(/ /g, "T")).toLocaleString("en-US", /*localeStringOptions*/ ctx[2]) + "")) set_data(t2, t2_value);
    			if (dirty & /*newsFeed*/ 2 && raw_value !== (raw_value = /*item*/ ctx[3].content + "")) html_tag.p(raw_value);
    		},
    		d(detaching) {
    ...
    // (67:4) {#each githubFeed as item}
    function create_each_block(ctx) {
    	let div;
    	let p0;
    	let a;
    	let t0_value = new Date(/*item*/ ctx[3].isoDate.replace(/ /g, "T")).toLocaleString("en-US", /*localeStringOptions*/ ctx[2]) + "";
    	let t0;
    	let a_href_value;
    	let t1;
    	let p1;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*githubFeed*/ 1 && t0_value !== (t0_value = new Date(/*item*/ ctx[3].isoDate.replace(/ /g, "T")).toLocaleString("en-US", /*localeStringOptions*/ ctx[2]) + "")) set_data(t0, t0_value);

    			if (dirty & /*githubFeed*/ 1 && a_href_value !== (a_href_value = /*item*/ ctx[3].link)) {
    				attr(a, "href", a_href_value);
    			}

    			if (dirty & /*githubFeed*/ 1 && t2_value !== (t2_value = /*item*/ ctx[3].title + "")) set_data(t2, t2_value);
    		},
    		d(detaching) {
    			if (detaching) detach(div);
    		}
    ...
    function create_fragment$4(ctx) {
    	...
    	let t17;
    	let t18;
    	let each_value_1 = /*newsFeed*/ ctx[1];
    	let each_blocks_1 = [];
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			p0 = element("p");
    			t2 = text("I'm a software developer in Miami, FL.");
    			t3 = space();
    			h11 = element("h1");
    			...
    			a0 = element("a");
    			t7 = text("TECKpert");
    			t8 = text(". In his spare-time, he's building\n        ");
    			a1 = element("a");
    			t9 = text("place4pals");
    			t10 = text(".");
    			t11 = space();
    		...
    		l(nodes) {
    			...
    			var p0_nodes = children(p0);
    			t2 = claim_text(p0_nodes, "I'm a software developer in Miami, FL.");
    			p0_nodes.forEach(detach);
    			...
    			var p1_nodes = children(p1);
    			t6 = claim_text(p1_nodes, "He works at\n        ");
    			a0 = claim_element(p1_nodes, "A", { target: true, href: true });
    			var a0_nodes = children(a0);
    			t7 = claim_text(a0_nodes, "TECKpert");
    			a0_nodes.forEach(detach);
    			t8 = claim_text(p1_nodes, ". In his spare-time, he's building\n        ");
    			a1 = claim_element(p1_nodes, "A", { target: true, href: true });
    			var a1_nodes = children(a1);
    			t9 = claim_text(a1_nodes, "place4pals");
    			...
    			img0 = claim_element(div2_nodes, "IMG", { alt: true, src: true });
    			t12 = claim_space(div2_nodes);
    			h12 = claim_element(div2_nodes, "H1", {});
    			var h12_nodes = children(h12);
    			t13 = claim_text(h12_nodes, "Chris Feed");
    			...
    			img1 = claim_element(div4_nodes, "IMG", { alt: true, src: true });
    			t16 = claim_space(div4_nodes);
    			h13 = claim_element(div4_nodes, "H1", {});
    			var h13_nodes = children(h13);
    			t17 = claim_text(h13_nodes, "GitHub Feed");
    		...
    		h() {
    			...
    			attr(a0, "href", "https://teckpert.com");
    			attr(a1, "target", "_blank");
    			attr(a1, "href", "https://place4pals.com");
    			attr(div1, "class", "textBlock");
    			attr(img0, "alt", "github");
    			if (img0.src !== (img0_src_value = "images/newspaper.svg")) attr(img0, "src", img0_src_value);
    			attr(div2, "class", "titleBar");
    			attr(div3, "class", "mainbar");
    			attr(img1, "alt", "github");
    			if (img1.src !== (img1_src_value = "images/github.svg")) attr(img1, "src", img1_src_value);
    			attr(div4, "class", "titleBar");
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*newsFeed, Date, localeStringOptions*/ 6) {
    				each_value_1 = /*newsFeed*/ ctx[1];
    				let i;
    			...
    			if (dirty & /*githubFeed, Date, localeStringOptions*/ 5) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	onMount(async function () {
    		...
    		response = await fetch("https://k1w3dj0nve.execute-api.us-east-2.amazonaws.com/prod?url=https://listed.to/@heythisischris/feed");

    		data = await response.json();
    		$$invalidate(1, newsFeed = data.items);
    		console.log(newsFeed);

    		//get github rss feed
    		response = await fetch("https://k1w3dj0nve.execute-api.us-east-2.amazonaws.com/prod?url=https://github.com/heythisischris/heythisischris-web/commits.atom");

    		data = await response.json();
    		$$invalidate(0, githubFeed = data.items);
    	});

    	return [githubFeed, newsFeed, localeStringOptions];
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c() {
    			h10 = element("h1");
    			t0 = text("Apps & Websites");
    			t1 = space();
    			div0 = element("div");
    			p0 = element("p");
    			t2 = text("Here are some of my projects outside of work.");
    			t3 = space();
    			div5 = element("div");
    			div2 = element("div");
    			a0 = element("a");
    			...
    			t6 = space();
    			span1 = element("span");
    			t7 = text("Minimalist social media service");
    			t8 = space();
    			span2 = element("span");
    			t9 = text("Built with React Native and Hasura");
    			t10 = space();
    			div4 = element("div");
    			a2 = element("a");
    			img1 = element("img");
    			...
    			a3 = element("a");
    			span3 = element("span");
    			t12 = text("Guardian Brothers Holdings");
    			t13 = space();
    			span4 = element("span");
    			t14 = text("Front-facing website for a mutual fund");
    			t15 = space();
    			span5 = element("span");
    			t16 = text("Built with Svelte");
    			t17 = space();
    			h11 = element("h1");
    			t18 = text("Music");
    			t19 = space();
    			div6 = element("div");
    			p1 = element("p");
    			t20 = text("I also enjoy recording- here are some albums I've released.");
    			t21 = space();
    			div12 = element("div");
    			div7 = element("div");
    			a4 = element("a");
    			...
    			t22 = space();
    			span6 = element("span");
    			t23 = text("family film");
    			t24 = space();
    			span7 = element("span");
    			t25 = text("July 2020 (soon!)");
    			t26 = space();
    			div8 = element("div");
    			a5 = element("a");
    			img3 = element("img");
    		...
    		l(nodes) {
    			...
    			var h10_nodes = children(h10);
    			t0 = claim_text(h10_nodes, "Apps & Websites");
    			h10_nodes.forEach(detach);
    			...
    			p0 = claim_element(div0_nodes, "P", {});
    			var p0_nodes = children(p0);
    			t2 = claim_text(p0_nodes, "Here are some of my projects outside of work.");
    			p0_nodes.forEach(detach);
    			div0_nodes.forEach(detach);
    			t3 = claim_space(nodes);
    			...
    			var div1_nodes = children(div1);
    			a1 = claim_element(div1_nodes, "A", { class: true, target: true, href: true });
    			var a1_nodes = children(a1);
    			span0 = claim_element(a1_nodes, "SPAN", {});
    			var span0_nodes = children(span0);
    			t5 = claim_text(span0_nodes, "place4pals");
    			span0_nodes.forEach(detach);
    			a1_nodes.forEach(detach);
    			t6 = claim_space(div1_nodes);
    			span1 = claim_element(div1_nodes, "SPAN", { class: true });
    			var span1_nodes = children(span1);
    			t7 = claim_text(span1_nodes, "Minimalist social media service");
    			span1_nodes.forEach(detach);
    			t8 = claim_space(div1_nodes);
    			span2 = claim_element(div1_nodes, "SPAN", { class: true });
    			var span2_nodes = children(span2);
    			t9 = claim_text(span2_nodes, "Built with React Native and Hasura");
    			...
    			div4 = claim_element(div5_nodes, "DIV", { class: true });
    			var div4_nodes = children(div4);
    			a2 = claim_element(div4_nodes, "A", { target: true, href: true });
    			...
    			var div3_nodes = children(div3);
    			a3 = claim_element(div3_nodes, "A", { class: true, target: true, href: true });
    			var a3_nodes = children(a3);
    			span3 = claim_element(a3_nodes, "SPAN", {});
    			var span3_nodes = children(span3);
    			t12 = claim_text(span3_nodes, "Guardian Brothers Holdings");
    			span3_nodes.forEach(detach);
    			a3_nodes.forEach(detach);
    			t13 = claim_space(div3_nodes);
    			span4 = claim_element(div3_nodes, "SPAN", { class: true });
    			var span4_nodes = children(span4);
    			t14 = claim_text(span4_nodes, "Front-facing website for a mutual fund");
    			span4_nodes.forEach(detach);
    			t15 = claim_space(div3_nodes);
    			span5 = claim_element(div3_nodes, "SPAN", { class: true });
    			var span5_nodes = children(span5);
    			t16 = claim_text(span5_nodes, "Built with Svelte");
    			...
    			var h11_nodes = children(h11);
    			t18 = claim_text(h11_nodes, "Music");
    			h11_nodes.forEach(detach);
    			...
    			var p1_nodes = children(p1);
    			t20 = claim_text(p1_nodes, "I also enjoy recording- here are some albums I've released.");
    			p1_nodes.forEach(detach);
    			div6_nodes.forEach(detach);
    			...
    			a4 = claim_element(div7_nodes, "A", { target: true, href: true });
    			var a4_nodes = children(a4);
    			img2 = claim_element(a4_nodes, "IMG", { alt: true, src: true, class: true });
    			a4_nodes.forEach(detach);
    			t22 = claim_space(div7_nodes);
    			span6 = claim_element(div7_nodes, "SPAN", {});
    			var span6_nodes = children(span6);
    			t23 = claim_text(span6_nodes, "family film");
    			span6_nodes.forEach(detach);
    			t24 = claim_space(div7_nodes);
    			span7 = claim_element(div7_nodes, "SPAN", { class: true });
    			var span7_nodes = children(span7);
    			t25 = claim_text(span7_nodes, "July 2020 (soon!)");
    			span7_nodes.forEach(detach);
    			div7_nodes.forEach(detach);
    			t26 = claim_space(div12_nodes);
    			div8 = claim_element(div12_nodes, "DIV", { class: true });
    			var div8_nodes = children(div8);
    			a5 = claim_element(div8_nodes, "A", { target: true, href: true });
    			var a5_nodes = children(a5);
    			img3 = claim_element(a5_nodes, "IMG", { alt: true, src: true, class: true });
    			a5_nodes.forEach(detach);
    			t27 = claim_space(div8_nodes);
    			span8 = claim_element(div8_nodes, "SPAN", {});
    			var span8_nodes = children(span8);
    			t28 = claim_text(span8_nodes, "poolhouse lp");
    			span8_nodes.forEach(detach);
    			t29 = claim_space(div8_nodes);
    			span9 = claim_element(div8_nodes, "SPAN", { class: true });
    			var span9_nodes = children(span9);
    			t30 = claim_text(span9_nodes, "May 2020");
    			span9_nodes.forEach(detach);
    			div8_nodes.forEach(detach);
    			t31 = claim_space(div12_nodes);
    			div9 = claim_element(div12_nodes, "DIV", { class: true });
    			var div9_nodes = children(div9);
    			a6 = claim_element(div9_nodes, "A", { target: true, href: true });
    			var a6_nodes = children(a6);
    			img4 = claim_element(a6_nodes, "IMG", { alt: true, src: true, class: true });
    			a6_nodes.forEach(detach);
    			t32 = claim_space(div9_nodes);
    			span10 = claim_element(div9_nodes, "SPAN", {});
    			var span10_nodes = children(span10);
    			t33 = claim_text(span10_nodes, "4 songs from pvd");
    			span10_nodes.forEach(detach);
    			t34 = claim_space(div9_nodes);
    			span11 = claim_element(div9_nodes, "SPAN", { class: true });
    			var span11_nodes = children(span11);
    			t35 = claim_text(span11_nodes, "Dec 2018");
    			span11_nodes.forEach(detach);
    			div9_nodes.forEach(detach);
    			t36 = claim_space(div12_nodes);
    			div10 = claim_element(div12_nodes, "DIV", { class: true });
    			var div10_nodes = children(div10);
    			a7 = claim_element(div10_nodes, "A", { target: true, href: true });
    			var a7_nodes = children(a7);
    			img5 = claim_element(a7_nodes, "IMG", { alt: true, src: true, class: true });
    			a7_nodes.forEach(detach);
    			t37 = claim_space(div10_nodes);
    			span12 = claim_element(div10_nodes, "SPAN", {});
    			var span12_nodes = children(span12);
    			t38 = claim_text(span12_nodes, "canvas face");
    			span12_nodes.forEach(detach);
    			t39 = claim_space(div10_nodes);
    			span13 = claim_element(div10_nodes, "SPAN", { class: true });
    			var span13_nodes = children(span13);
    			t40 = claim_text(span13_nodes, "Oct 2016");
    			span13_nodes.forEach(detach);
    			div10_nodes.forEach(detach);
    			t41 = claim_space(div12_nodes);
    			div11 = claim_element(div12_nodes, "DIV", { class: true });
    			var div11_nodes = children(div11);
    			a8 = claim_element(div11_nodes, "A", { target: true, href: true });
    			var a8_nodes = children(a8);
    			img6 = claim_element(a8_nodes, "IMG", { alt: true, src: true, class: true });
    			a8_nodes.forEach(detach);
    			t42 = claim_space(div11_nodes);
    			span14 = claim_element(div11_nodes, "SPAN", {});
    			var span14_nodes = children(span14);
    			t43 = claim_text(span14_nodes, "lightheaded");
    			...
    			t45 = claim_text(span15_nodes, "Feb 2013");
    		...
    		h() {
    			attr(div0, "class", "textBlock");
    			attr(img0, "alt", "");
    			if (img0.src !== (img0_src_value = "/images/apps/place4pals.jpg")) attr(img0, "src", img0_src_value);
    			attr(img0, "class", "svelte-ot4zjt");
    			attr(a0, "target", "_blank");
    			attr(a0, "href", "https://place4pals.com");
    			attr(a1, "class", "noLinkColor svelte-ot4zjt");
    			attr(a1, "target", "_blank");
    			attr(a1, "href", "https://place4pals.com");
    			attr(span1, "class", "portfolioDate svelte-ot4zjt");
    			attr(span2, "class", "portfolioDate svelte-ot4zjt");
    			attr(div1, "class", "svelte-ot4zjt");
    			attr(div2, "class", "portfolioItem svelte-ot4zjt");
    			attr(img1, "alt", "");
    			if (img1.src !== (img1_src_value = "/images/apps/guardianbrothers.svg")) attr(img1, "src", img1_src_value);
    			set_style(img1, "height", "auto");
    			attr(img1, "class", "svelte-ot4zjt");
    			attr(a2, "target", "_blank");
    			attr(a2, "href", "https://guardianbrothers.com");
    			attr(a3, "class", "noLinkColor svelte-ot4zjt");
    			attr(a3, "target", "_blank");
    			attr(a3, "href", "https://guardianbrothers.com");
    			attr(span4, "class", "portfolioDate svelte-ot4zjt");
    			attr(span5, "class", "portfolioDate svelte-ot4zjt");
    			attr(div3, "class", "svelte-ot4zjt");
    			attr(div4, "class", "portfolioItem svelte-ot4zjt");
    			attr(div5, "class", "portfolioContainer svelte-ot4zjt");
    			attr(div6, "class", "textBlock");
    			attr(img2, "alt", "");
    			if (img2.src !== (img2_src_value = "/images/music/familyfilm.jpg")) attr(img2, "src", img2_src_value);
    			attr(img2, "class", "svelte-ot4zjt");
    			attr(a4, "target", "_blank");
    			attr(a4, "href", "https://familyfilm.net");
    			attr(span7, "class", "portfolioDate svelte-ot4zjt");
    			attr(div7, "class", "musicItem svelte-ot4zjt");
    			attr(img3, "alt", "");
    			if (img3.src !== (img3_src_value = "/images/music/poolhouselp.jpg")) attr(img3, "src", img3_src_value);
    			attr(img3, "class", "svelte-ot4zjt");
    			attr(a5, "target", "_blank");
    			attr(a5, "href", "https://poolhouselp.com");
    			attr(span9, "class", "portfolioDate svelte-ot4zjt");
    			attr(div8, "class", "musicItem svelte-ot4zjt");
    			attr(img4, "alt", "");
    			if (img4.src !== (img4_src_value = "/images/music/4songsfromprovidence.jpg")) attr(img4, "src", img4_src_value);
    			attr(img4, "class", "svelte-ot4zjt");
    			attr(a6, "target", "_blank");
    			attr(a6, "href", "https://thebreakersproject.bandcamp.com/");
    			attr(span11, "class", "portfolioDate svelte-ot4zjt");
    			attr(div9, "class", "musicItem svelte-ot4zjt");
    			attr(img5, "alt", "");
    			if (img5.src !== (img5_src_value = "/images/music/canvasface.jpg")) attr(img5, "src", img5_src_value);
    			attr(img5, "class", "svelte-ot4zjt");
    			attr(a7, "target", "_blank");
    			attr(a7, "href", "https://heythisischris.bandcamp.com/album/canvas-face");
    			attr(span13, "class", "portfolioDate svelte-ot4zjt");
    			attr(div10, "class", "musicItem svelte-ot4zjt");
    			attr(img6, "alt", "");
    			if (img6.src !== (img6_src_value = "/images/music/lightheaded.jpg")) attr(img6, "src", img6_src_value);
    			attr(img6, "class", "svelte-ot4zjt");
    			attr(a8, "target", "_blank");
    			attr(a8, "href", "https://heythisischris.bandcamp.com/album/lightheaded");
    			attr(span15, "class", "portfolioDate svelte-ot4zjt");
    			attr(div11, "class", "musicItem svelte-ot4zjt");
    			attr(div12, "class", "portfolioContainer svelte-ot4zjt");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			t55 = space();
    			li13 = element("li");
    			t56 = text("Won 1st Place in National Competition, received over $20,000 in funding for our school");
    			t57 = space();
    			p4 = element("p");
    			strong3 = element("strong");
    			t58 = text("Game Developer,");
    			t59 = text("\n    2008\n  ");
    			br5 = element("br");
    			t60 = text("Self-employed, Miami, Florida");
    			t61 = space();
    			ul4 = element("ul");
    			li14 = element("li");
    			t62 = text("Programmed several Flash games");
    			t63 = space();
    			li15 = element("li");
    			t64 = text("Sold ");
    			a8 = element("a");
    			t65 = text("Dodge");
    			t66 = text(" to Fettspielen.de, a German game portal.");
    			t67 = space();
    			h13 = element("h1");
    			t68 = text("Involvement");
    			t69 = space();
    			div3 = element("div");
    			p5 = element("p");
    			strong4 = element("strong");
    			t70 = text("Programming Mentor");
    			t71 = text(", August 2017 – December 2017\n  ");
    			br6 = element("br");
    			t72 = text("First Time Programmers Club, University of Florida");
    			t73 = space();
    			ul5 = element("ul");
    			li16 = element("li");
    			t74 = text("Assisted undergraduate programming majors in learning coding concepts and\n      completing their coursework");
    			t75 = space();
    			h14 = element("h1");
    			t76 = text("Skills");
    			t77 = space();
    			...
    			t78 = text("Cloud Environments:");
    			t79 = text("\n    AWS (strongest), DigitalOcean, Azure");
    			br7 = element("br");
    			t80 = space();
    		...
    		l(nodes) {
    			...
    			a0 = claim_element(p2_nodes, "A", { target: true, href: true });
    			var a0_nodes = children(a0);
    			...
    			a1 = claim_element(li1_nodes, "A", { target: true, href: true });
    			var a1_nodes = children(a1);
    			...
    			a2 = claim_element(li2_nodes, "A", { target: true, href: true });
    			var a2_nodes = children(a2);
    			...
    			a3 = claim_element(li3_nodes, "A", { target: true, href: true });
    			var a3_nodes = children(a3);
    			...
    			a4 = claim_element(li4_nodes, "A", { target: true, href: true });
    			var a4_nodes = children(a4);
    			...
    			a5 = claim_element(li5_nodes, "A", { target: true, href: true });
    			var a5_nodes = children(a5);
    			...
    			a6 = claim_element(li11_nodes, "A", { target: true, href: true });
    			var a6_nodes = children(a6);
    			...
    			a7 = claim_element(li12_nodes, "A", { target: true, href: true });
    			var a7_nodes = children(a7);
    			...
    			t56 = claim_text(li13_nodes, "Won 1st Place in National Competition, received over $20,000 in funding for our school");
    			...
    			t58 = claim_text(strong3_nodes, "Game Developer,");
    			strong3_nodes.forEach(detach);
    			t59 = claim_text(p4_nodes, "\n    2008\n  ");
    			br5 = claim_element(p4_nodes, "BR", {});
    			t60 = claim_text(p4_nodes, "Self-employed, Miami, Florida");
    			...
    			t62 = claim_text(li14_nodes, "Programmed several Flash games");
    			li14_nodes.forEach(detach);
    			t63 = claim_space(ul4_nodes);
    			li15 = claim_element(ul4_nodes, "LI", {});
    			var li15_nodes = children(li15);
    			t64 = claim_text(li15_nodes, "Sold ");
    			a8 = claim_element(li15_nodes, "A", { target: true, href: true });
    			var a8_nodes = children(a8);
    			t65 = claim_text(a8_nodes, "Dodge");
    			a8_nodes.forEach(detach);
    			t66 = claim_text(li15_nodes, " to Fettspielen.de, a German game portal.");
    			...
    			var h13_nodes = children(h13);
    			t68 = claim_text(h13_nodes, "Involvement");
    			h13_nodes.forEach(detach);
    			...
    			t70 = claim_text(strong4_nodes, "Programming Mentor");
    			strong4_nodes.forEach(detach);
    			t71 = claim_text(p5_nodes, ", August 2017 – December 2017\n  ");
    			br6 = claim_element(p5_nodes, "BR", {});
    			t72 = claim_text(p5_nodes, "First Time Programmers Club, University of Florida");
    			...
    			t74 = claim_text(li16_nodes, "Assisted undergraduate programming majors in learning coding concepts and\n      completing their coursework");
    			...
    			t76 = claim_text(h14_nodes, "Skills");
    			...
    			t78 = claim_text(strong5_nodes, "Cloud Environments:");
    			strong5_nodes.forEach(detach);
    			t79 = claim_text(p6_nodes, "\n    AWS (strongest), DigitalOcean, Azure");
    			br7 = claim_element(p6_nodes, "BR", {});
    			t80 = claim_space(p6_nodes);
    			strong6 = claim_element(p6_nodes, "STRONG", {});
    			var strong6_nodes = children(strong6);
    			t81 = claim_text(strong6_nodes, "Languages:");
    			strong6_nodes.forEach(detach);
    			t82 = claim_text(p6_nodes, "\n    JavaScript, React, React Native, Angular, PHP, ASP, C# (.NET), Java, Swift,\n    Obj-C, C++");
    			br8 = claim_element(p6_nodes, "BR", {});
    			t83 = claim_space(p6_nodes);
    			strong7 = claim_element(p6_nodes, "STRONG", {});
    			var strong7_nodes = children(strong7);
    			t84 = claim_text(strong7_nodes, "Databases:");
    			strong7_nodes.forEach(detach);
    			t85 = claim_text(p6_nodes, "\n    MySQL, PostgreSQL, MongoDB, DynamoDB");
    			br9 = claim_element(p6_nodes, "BR", {});
    			t86 = claim_space(p6_nodes);
    			strong8 = claim_element(p6_nodes, "STRONG", {});
    			var strong8_nodes = children(strong8);
    			t87 = claim_text(strong8_nodes, "IDEs and Software:");
    			strong8_nodes.forEach(detach);
    			t88 = claim_text(p6_nodes, "\n    VS Code, Git Bash, Xcode, Notepad++, Android Studio");
    			br10 = claim_element(p6_nodes, "BR", {});
    			t89 = claim_space(p6_nodes);
    			strong9 = claim_element(p6_nodes, "STRONG", {});
    			var strong9_nodes = children(strong9);
    			t90 = claim_text(strong9_nodes, "Languages:");
    			strong9_nodes.forEach(detach);
    			t91 = claim_text(p6_nodes, "\n    Spanish (fluent)");
    		...
    		h() {
    			...
    			attr(a0, "href", "https://teckpert.com");
    			attr(a1, "target", "_blank");
    			attr(a1, "href", "https://corkagefee.com");
    			attr(a2, "target", "_blank");
    			attr(a2, "href", "https://realdash.com");
    			attr(a3, "target", "_blank");
    			attr(a3, "href", "https://roamwith.com");
    			attr(a4, "target", "_blank");
    			attr(a4, "href", "https://castcloud.me");
    			attr(a5, "target", "_blank");
    			attr(a5, "href", "https://csklegal.com");
    			attr(a6, "target", "_blank");
    			attr(a6, "href", "https://hospitalistapp.com");
    			set_style(ul2, "margin-top", "-15px");
    			attr(a7, "target", "_blank");
    			attr(a7, "href", "https://dontbeadrain.com");
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			p0 = element("p");
    			t2 = text("Christopher James Aitken (I'm 25, he/him)");
    			t3 = space();
    			h11 = element("h1");
    			t4 = text("Email");
    			t5 = space();
    			...
    			div7 = element("div");
    			h14 = element("h1");
    			t21 = text("Response ETA?");
    			t22 = space();
    			div6 = element("div");
    			p7 = element("p");
    			t23 = text("Usually within a few hours, I check my email pretty frequently.");
    			this.h();
    		},
    		l(nodes) {
    			...
    			var div5_nodes = children(div5);
    			h10 = claim_element(div5_nodes, "H1", {});
    			var h10_nodes = children(h10);
    			...
    			p0 = claim_element(div0_nodes, "P", {});
    			var p0_nodes = children(p0);
    			t2 = claim_text(p0_nodes, "Christopher James Aitken (I'm 25, he/him)");
    			p0_nodes.forEach(detach);
    			div0_nodes.forEach(detach);
    			t3 = claim_space(div5_nodes);
    			h11 = claim_element(div5_nodes, "H1", {});
    			var h11_nodes = children(h11);
    			...
    			a0 = claim_element(p1_nodes, "A", { target: true, href: true });
    			var a0_nodes = children(a0);
    			t6 = claim_text(a0_nodes, "chris@heythisischris.com");
    			a0_nodes.forEach(detach);
    			p1_nodes.forEach(detach);
    			div1_nodes.forEach(detach);
    			...
    			var h12_nodes = children(h12);
    			t8 = claim_text(h12_nodes, "Social Media");
    			h12_nodes.forEach(detach);
    			...
    			p2 = claim_element(div2_nodes, "P", {});
    			var p2_nodes = children(p2);
    			a1 = claim_element(p2_nodes, "A", { target: true, href: true });
    			var a1_nodes = children(a1);
    			img0 = claim_element(a1_nodes, "IMG", { class: true, alt: true, src: true });
    			a1_nodes.forEach(detach);
    			t10 = claim_space(p2_nodes);
    			a2 = claim_element(p2_nodes, "A", { target: true, href: true });
    			var a2_nodes = children(a2);
    			img1 = claim_element(a2_nodes, "IMG", { class: true, alt: true, src: true });
    			a2_nodes.forEach(detach);
    			t11 = claim_space(p2_nodes);
    			a3 = claim_element(p2_nodes, "A", { target: true, href: true });
    			var a3_nodes = children(a3);
    			img2 = claim_element(a3_nodes, "IMG", { class: true, alt: true, src: true });
    			a3_nodes.forEach(detach);
    			t12 = claim_space(p2_nodes);
    			a4 = claim_element(p2_nodes, "A", { target: true, href: true });
    			var a4_nodes = children(a4);
    			img3 = claim_element(a4_nodes, "IMG", { class: true, alt: true, src: true });
    			a4_nodes.forEach(detach);
    			p2_nodes.forEach(detach);
    			div2_nodes.forEach(detach);
    			div3_nodes.forEach(detach);
    			...
    			var h13_nodes = children(h13);
    			t14 = claim_text(h13_nodes, "Leave me a message");
    			h13_nodes.forEach(detach);
    			...
    			var p3_nodes = children(p3);
    			input0 = claim_element(p3_nodes, "INPUT", { class: true, placeholder: true });
    			p3_nodes.forEach(detach);
    			t16 = claim_space(div4_nodes);
    			p4 = claim_element(div4_nodes, "P", {});
    			var p4_nodes = children(p4);
    			input1 = claim_element(p4_nodes, "INPUT", { class: true, placeholder: true });
    			p4_nodes.forEach(detach);
    			t17 = claim_space(div4_nodes);
    			p5 = claim_element(div4_nodes, "P", {});
    			var p5_nodes = children(p5);
    			textarea = claim_element(p5_nodes, "TEXTAREA", { class: true, placeholder: true });
    			children(textarea).forEach(detach);
    			p5_nodes.forEach(detach);
    			t18 = claim_space(div4_nodes);
    			p6 = claim_element(div4_nodes, "P", { class: true });
    			var p6_nodes = children(p6);
    			button = claim_element(p6_nodes, "BUTTON", { class: true, onclick: true });
    			var button_nodes = children(button);
    			t19 = claim_text(button_nodes, "Send");
    			...
    			var div7_nodes = children(div7);
    			h14 = claim_element(div7_nodes, "H1", {});
    			var h14_nodes = children(h14);
    			t21 = claim_text(h14_nodes, "Response ETA?");
    			h14_nodes.forEach(detach);
    			t22 = claim_space(div7_nodes);
    			...
    			t23 = claim_text(p7_nodes, "Usually within a few hours, I check my email pretty frequently.");
    		...
    		h() {
    			...
    			attr(a2, "target", "_blank");
    			attr(a2, "href", "https://www.linkedin.com/in/chris-aitken-293045183/");
    			...
    			attr(a3, "target", "_blank");
    			attr(a3, "href", "https://www.instagram.com/heythisischris/");
    			...
    			attr(a4, "target", "_blank");
    			attr(a4, "href", "https://www.facebook.com/chrisaitken");
    			attr(div2, "class", "textBlock");
    			attr(div3, "id", "mobileSocialMedia");
    			...
    			attr(button, "onclick", "alert('Sorry, this feature doesn\\'t work yet!')");
    			attr(p6, "class", "send svelte-110ujhe");
    			attr(div4, "class", "textBlock");
    			attr(div5, "class", "mainbar");
    			attr(div6, "class", "textBlock");
    			attr(div7, "class", "sidebar");
    			attr(div8, "class", "mainbarAndSidebarContainer");
    		},
    		m(target, anchor) {
    ...
    function create_default_slot$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t13 = space();
    			div6 = element("div");
    			t14 = text("Copyright © 2020 Chris Aitken");
    			this.h();
    		},
    		l(nodes) {
    			div5 = claim_element(nodes, "DIV", { class: true });
    			...
    			div6 = claim_element(nodes, "DIV", { class: true });
    			var div6_nodes = children(div6);
    			t14 = claim_text(div6_nodes, "Copyright © 2020 Chris Aitken");
    			div6_nodes.forEach(detach);
    			this.h();
    		},
    		h() {
