(function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			span0 = element("span");
    			t2 = text("⤷");
    			t3 = text("I'm an application developer based in Miami, FL.");
    			t4 = space();
    			h11 = element("h1");
    			t5 = text("What does Chris do now?");
    			t6 = space();
    			p1 = element("p");
    			span1 = element("span");
    			t7 = text("⤷");
    			t8 = text("He works at TECKpert. In his spare-time, he's building place4pals.");
    			this.h();
    		},
    		l(nodes) {
    			...
    			span0 = claim_element(p0_nodes, "SPAN", { style: true });
    			var span0_nodes = children(span0);
    			t2 = claim_text(span0_nodes, "⤷");
    			span0_nodes.forEach(detach);
    			t3 = claim_text(p0_nodes, "I'm an application developer based in Miami, FL.");
    			p0_nodes.forEach(detach);
    			t4 = claim_space(nodes);
    			h11 = claim_element(nodes, "H1", {});
    			var h11_nodes = children(h11);
    			t5 = claim_text(h11_nodes, "What does Chris do now?");
    			h11_nodes.forEach(detach);
    			t6 = claim_space(nodes);
    			p1 = claim_element(nodes, "P", {});
    			var p1_nodes = children(p1);
    			span1 = claim_element(p1_nodes, "SPAN", { style: true });
    			var span1_nodes = children(span1);
    			t7 = claim_text(span1_nodes, "⤷");
    			span1_nodes.forEach(detach);
    			t8 = claim_text(p1_nodes, "He works at TECKpert. In his spare-time, he's building place4pals.");
    		...
    		h() {
    			...
    			set_style(span1, "font-size", "25px");
    ...
    /* src\routes\Test.svelte generated by Svelte v3.18.1 */
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c() {
    			...
    			t1 = space();
    			p = element("p");
    			t2 = text("This is a test route");
    		},
    		l(nodes) {
    			h1 = claim_element(nodes, "H1", {});
    			var h1_nodes = children(h1);
    			t0 = claim_text(h1_nodes, "Resume");
    			h1_nodes.forEach(detach);
    			t1 = claim_space(nodes);
    			p = claim_element(nodes, "P", {});
    			var p_nodes = children(p);
    			t2 = claim_text(p_nodes, "This is a test route");
    ...
    function create_default_slot$1(ctx) {
    	...
    	const route1 = new Route({
    			props: { path: "resume", component: Test }
    		});
    	...
    	return {
    		...
    		l(nodes) {
    			...
    			claim_component(route0.$$.fragment, div3_nodes);
    			t6 = claim_space(div3_nodes);
    			claim_component(route1.$$.fragment, div3_nodes);
    		...
    		h() {
    			...
    			attr(div2, "class", "navContainer");
    			attr(div3, "class", "pageContainer");
