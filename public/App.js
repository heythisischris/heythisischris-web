...
const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <nav>
    ...
    ${validate_component(NavLink, "NavLink").$$render($$result, { to: "apps" }, {}, { default: () => `Apps` })}
    ${validate_component(NavLink, "NavLink").$$render($$result, { to: "sites" }, {}, { default: () => `Sites` })}
    ${validate_component(NavLink, "NavLink").$$render($$result, { to: "film" }, {}, { default: () => `Film` })}
    ${validate_component(NavLink, "NavLink").$$render($$result, { to: "music" }, {}, { default: () => `Music` })}
  </nav>
  <div>
    ${validate_component(Route, "Route").$$render($$result, { path: "/", component: Home }, {}, {})}
    ${validate_component(Route, "Route").$$render($$result, { path: "resume", component: Test }, {}, {})}
  </div>
`
	})}`;
});
